"""
Django settings for empires project.
...
SECRET_KEY = 'django-insecure-az0%1a8f%*o3fs2sm87%feaj+c^7q)$j&xw10(-)9o3w^jtf3i'
...
ROOT_URLCONF = 'empires.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ["empires/templates"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'empires.wsgi.application'
